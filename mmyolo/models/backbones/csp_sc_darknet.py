...
from ..layers import CSPLayerWithTwoConv, SPPFBottleneck, DarknetBottleneck
...
from ..plugins.sconv import ScConv
from mmcv.cnn import (ConvModule, DepthwiseSeparableConvModule, MaxPool2d,
                      build_norm_layer)
class SCDarknetBottleneck(MMDET_DarknetBottleneck):
...
class SCCSPLayerWithTwoConv(BaseModule):
